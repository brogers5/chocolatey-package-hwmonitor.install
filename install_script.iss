...
AppVerName=CPUID HWMonitor 1.65
...
OutputBaseFilename=tmpare3jy.tmp
Compression=lzma
...
Root: HKLM; Subkey: "Software\CPUID\HWMonitor"; ValueName: "VERSION"; ValueType: String; ValueData: "1.65"; 
