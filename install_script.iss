...
AppVerName=CPUID HWMonitor 1.60
...
OutputBaseFilename=tmpwpp3vn.tmp
Compression=lzma
...
Root: HKLM; Subkey: "Software\CPUID\HWMonitor"; ValueName: "VERSION"; ValueType: String; ValueData: "1.60"; 
