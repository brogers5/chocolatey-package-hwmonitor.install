...
AppVerName=CPUID HWMonitor 1.67
...
OutputBaseFilename=tmpqubd3s.tmp
Compression=lzma
...
Root: HKLM; Subkey: "Software\CPUID\HWMonitor"; ValueName: "VERSION"; ValueType: String; ValueData: "1.67"; 
