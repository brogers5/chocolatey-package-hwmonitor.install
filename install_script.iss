...
AppVerName=CPUID HWMonitor 1.62
...
OutputBaseFilename=tmpmu4apo.tmp
Compression=lzma
...
Root: HKLM; Subkey: "Software\CPUID\HWMonitor"; ValueName: "VERSION"; ValueType: String; ValueData: "1.62"; 
